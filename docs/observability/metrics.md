...
| kubevirt_vmi_guest_device_driver_date_seconds | Metric | Gauge | Guest device driver date as Unix epoch seconds, reported by the QEMU guest agent guest-get-devices command. |
